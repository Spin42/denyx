...
| [security-pentest-r2-tool-poisoning](security-pentest-r2-tool-poisoning.md) | Round 2 (2026-05-11): 4-model probe of the `delegate_to_local` step-parameter injection surface and Round-1-OOSC encoding bypass. 0 leaks across 64 attempts; honesty-gap recommendations for the threat-model docs (the `<task>`-wrapper defenses are not security boundaries). |
